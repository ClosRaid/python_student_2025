...
def getBirthday(numberOfbirthdays):
    ...
    return birthdays
def getMatch(birthday): # 1. Названия дней рождения birthday
    # возвращать объект даты рождения, встречащегося несколько раз в списке дня рождения
...
def main():
    month = ("jan","feb","march","april","may","june",
             "jul","aug","sep","oct","nov","dec") # 4. Заменить сокращения на полноценные слова
    while True:
        ...
        for i in range(100): # 2. заменить число 100 на нужное, или зациклить через while до бесконечности
            if i % 100 == 0:
                print(i, "Симуляция")
            birthdays = getBirthday(numBDays)
...
if __name__ == '__main__':
    main()
# 3. я пропустил видимо, у меня такой строчки numBDays = int(respons) нету, только numBDays = response, но при
# комментировании ничего не происходит, никакой ошибки нет